...
<!--<script>-->
  ...
  <!--export default {-->
    ...
    <!--async asyncData ({ params, app, store }) {-->
      ...
      <!--let option = {-->
        <!--url: `/api/AptList/GetPaging?StartDateTime=%7BStartDateTime%7D&EndDateTime=%7BEndDateTime%7D&SiteID=${store.state.siteId}&StoresId=%7BStoresId%7D&OrderNum=%7BOrderNum%7D&pagesize=${5}&pagenum=${pageNumber}&type=0`,-->
        <!--method: 'GET',-->
        <!--headers: {-->
    ...
    <!--},-->
    <!--mounted(){-->
      <!--this.loadMoreActive = (document.documentElement.clientWidth <= 768 && this.$store.state.btnList[1].num > 5)-->
      <!--this.loadMoreData()-->
    <!--},-->
    <!--methods: {-->
      <!--loadMoreData(){-->
...
<template>
  <OrderListTemplate :list="list" :btnListIndex="1" dataFiled="RepairList"/>
  <!--<div>-->
  <!--<div class="main-order">-->
  <!--<OrderCell v-for="(item, key) in list" :key="key" :item="item"/>-->
  <!--</div>-->
...
<script>
  import OrderCell from '../../../components/OrderCell'
  import OrderCellMobile from '../../../components/OrderCellMobile'
  import OrderListTemplate from '../../../components/OrderListTemplate'
  import Mock from 'mockjs'
