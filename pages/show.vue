  ...
  <div class="container">
    ...
    <div class="navbar">
      <div class="navbar-container">
        <span>
          <nuxt-link to="/">首页</nuxt-link> > <nuxt-link to="/case">维修案例</nuxt-link> > 追光者，股东百达斐丽3445翻新记
        </span>
      </div>
    </div>
    ...
    <main class="main">
      <div class="main-left">
        <h1 class="title">追光者，股东百达翡丽3445翻新记</h1>
        <p class="article-info">
          <span>作者：小辛</span>
          <span>来源：西亨名表维修</span>
          <span>发布时间：2018-08-03</span>
        </p>
        <article id="article" v-html="html">
    ...
    head () {
      return {
        ...
        meta: [
          ...
          { name: 'description', content: this.html },
        ]
      }
    },
    name: "show",
